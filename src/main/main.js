// ═══════════════════════════════════════════════════════════════════════
// Haxys Core — Desktop App
// Electron wrapper for core.haxys.com.br
// ═══════════════════════════════════════════════════════════════════════
...
// ── Constants ────────────────────────────────────────────────────────
const HAXYS_URL = 'https://core.haxys.com.br/';
const SESSION_PARTITION = 'persist:haxyscore';
...
function configureSession() {
  ...
  console.log(`[HaxysCore] Session configured — Chrome/${chromeVersion}`);
}
...
function isAllowedURL(url) {
  try {
    ...
    return (
      parsed.hostname === 'core.haxys.com.br' ||
...
function openLoginPopup(loginURL) {
  ...
  console.log('[HaxysCore] Login popup opened with mobile UA');
}
